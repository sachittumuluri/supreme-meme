        ...
        try:
            if uploaded_file is not None:
                ...
                if "patient" in df.columns:
                    patient = False   
                    st.info("Unhealthy Patient Detected", icon="ℹ️")
                else:
                    patient=True
                    st.info("Healthy Patient Detected", icon="ℹ️")    
                ...
                if patient:
                    st.write("#### Time series embedding for Healthy patient ")
                else:
                    st.write("#### Time series embedding for an Unhealthy patient ")    
